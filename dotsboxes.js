(function () {
  ...
  console.log(
    "🔥 DOTSBOXES.JS LOADED — FIXED VERSION"
  );
  ...
  /* =========================================================
     ...
     IMPORTANT:
     This function is ONLY called when the player
  ...
  async function saveDotsBoxesWin() {
    ...
    console.trace(
      "🔥 saveDotsBoxesWin() WAS CALLED"
    );

    if (dotsBoxesWinSaved) {

      console.log(
        "Dots & Boxes win was already saved."
      );
    ...
    /*
     * Do NOT create a fake "Player" account.
     * If there is no username, do not save.
     */

    if (!username) {

      console.error(
        "NO USERNAME FOUND — WIN NOT SAVED."
      );
    ...
    try {
      ...
      if (!existingPlayer) {
        ...
        console.log(
          "Player does not exist yet. Creating:",
          username
        );
         ...
         * IMPORTANT:
         *
         * DO NOT insert total_wins.
         *
         * Supabase calculates total_wins
       ...
       * IMPORTANT:
       *
       * Again, DO NOT update total_wins.
  ...
  function checkGameOver() {
    ...
    if (
       ...
       *   IS CALLED.
       *
       * Therefore it cannot save a win
  ...
  function startGame() {
    ...
    /*
     * Reset save protection for THIS game.
     *
     * It does NOT save anything here.
     */
